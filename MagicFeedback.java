...
public class MagicFeedback {
	...
	public static void main(String[] args) {
		...
		float overallshow1=(show1/100)*(rating1/10);
		float overallshow2=(show2/100)*(rating2/10);
		float overallshow3=(show3/100)*(rating3/10);
		float overall=overallshow1+overallshow2+overallshow3;
